...
#   /$$$$$$  /$$$$$$$$ /$$$$$$$$ /$$   /$$ /$$$$$$$        /$$$$$$$  /$$$$$$$$ /$$$$$$$  /$$$$$$$$ /$$   /$$ /$$$$$$$  /$$$$$$$$ /$$   /$$  /$$$$$$  /$$$$$$ /$$$$$$$$  /$$$$$$
#  /$$__  $$| $$_____/|__  $$__/| $$  | $$| $$__  $$      | $$__  $$| $$_____/| $$__  $$| $$_____/| $$$ | $$| $$__  $$| $$_____/| $$$ | $$ /$$__  $$|_  $$_/| $$_____/ /$$__  $$
# | $$  \__/| $$         | $$   | $$  | $$| $$  \ $$      | $$  \ $$| $$      | $$  \ $$| $$      | $$$$| $$| $$  \ $$| $$      | $$$$| $$| $$  \__/  | $$  | $$      | $$  \__/
# |  $$$$$$ | $$$$$      | $$   | $$  | $$| $$$$$$$/      | $$  | $$| $$$$$   | $$$$$$$/| $$$$$   | $$ $$ $$| $$  | $$| $$$$$   | $$ $$ $$| $$        | $$  | $$$$$   |  $$$$$$
#  \____  $$| $$__/      | $$   | $$  | $$| $$____/       | $$  | $$| $$__/   | $$____/ | $$__/   | $$  $$$$| $$  | $$| $$__/   | $$  $$$$| $$        | $$  | $$__/    \____  $$
#  /$$  \ $$| $$         | $$   | $$  | $$| $$            | $$  | $$| $$      | $$      | $$      | $$\  $$$| $$  | $$| $$      | $$\  $$$| $$    $$  | $$  | $$       /$$  \ $$
# |  $$$$$$/| $$$$$$$$   | $$   |  $$$$$$/| $$            | $$$$$$$/| $$$$$$$$| $$      | $$$$$$$$| $$ \  $$| $$$$$$$/| $$$$$$$$| $$ \  $$|  $$$$$$/ /$$$$$$| $$$$$$$$|  $$$$$$/
#  \______/ |________/   |__/    \______/ |__/            |_______/ |________/|__/      |________/|__/  \__/|_______/ |________/|__/  \__/ \______/ |______/|________/ \______/
...
setupFolders() {
    ...
    # create folder for Makefile backups
    mkdir $MAKE_BACKUP_ROOT
}

getLatestRelease() {
    wget -O --silent "https://api.github.com/repos/$1/releases/latest" | # Get latest release from GitHub api
...
downloadRP3D() {
    ...
    cmake . # cmake it (no parameters needed, except for current directory, which is the dot)
...
then
    ...
    setupFolders # BEFORE ANYTHING ELSE, THE FOLDERS MUST BE SET UP!
    downloadNginxDependencies # uWebSockets needs some of the same dependencies
...
then
    echo "Uninstalling various programs"
    cd $MAKE_BACKUP_ROOT
    make -f Makefile-pcre uninstall
    make -f Makefile-zlib uninstall
    make -f Makefile-openssl uninstall
elif [ "$1" = "clean" ]
then
